...
(async function () {
  ...
  const generateExclSheet = function (worksheet, columnTitles, arr) {
  ...
  generateExclSheet(worksheet1, group1Keys, group1);
  generateExclSheet(worksheet2, group2Keys, group2);
  generateExclSheet(worksheet3, group3Keys, group3);
